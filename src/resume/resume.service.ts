...
export class ResumeService {
  ...
  async reStructureData() {
    ...
    for (let index = 0; index < (resData.ResumeParserData.SegregatedQualification ? resData.ResumeParserData.SegregatedQualification.length : 0); index++) {
      ...
      //   subInstitutionName: element.Institution ? element.Institution.Name : "",
      //   subInstitutionConfidenceScore: element.Degree,
      //   subInstitutionType: element.Degree,
      //   subInstitutionCity: element.Degree,
      //   subInstitutionState: element.Degree,
      //   subInstitutionStateIsoCode: element.Degree,
      //   subInstitutionCountry: element.Degree,
      //   subInstitutionIsoAlpha2: element.Degree,
      //   subInstitutionIsoAlpha3: element.Degree,
      //   subInstitutionUNCode: element.Degree,
      //   degreeName: element.Degree,
      //   normalizeDegree: element.Degree,
      //   degreeScore: element.Degree,
      //   specialization: element.Degree,
      //   formattedDegreePeriod: element.Degree,
      //   startDate: element.Degree,
      //   endDate: element.Degree,
      //   aggregateValue: element.Degree,
      //   aggregateMeasureType: element.Degree,
      // })
    }
    // {
    //   "Institution": {
