    ...
    async uploadResume(res) {
        ...
        for (let index = 0; index < (resData.ResumeParserData.SegregatedExperience ? resData.ResumeParserData.SegregatedExperience.length : 0); index++) {
            ...
            if (element.Employer) {
                ...
                nObj = Object.assign(Object.assign({}, nObj), { jobPeriod: element.JobPeriod, formattedJobPeriod: element.FormattedJobPeriod, startDate: element.StartDate, endDate: element.EndDate, isCurrentEmployer: element.IsCurrentEmployer, jobDescription: element.JobDescription });
            }
            let projects = '';
